...
public class Person implements Comparable<Person>, Serializable {
     ...
     * @param coordinates объект models.Coordinates
     ...
     * @param eyeColor значение models.Color (может быть null)
     */
     ...
     * @param nationality значение models.Country
     ...
     * @param location объект models.Location
     ...
     * @return объект models.Coordinates
     */
     ...
     * @return значение models.Color или null
     */
    public Color getEyeColor() { return eyeColor; }
    /**
     * Возвращает национальность.
     * @return значение models.Country
     */
    public Country getNationality() { return nationality; }
    /**
     * Возвращает локацию.
     * @return объект models.Location
     */
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, coordinates, creationDate, height, passportID, eyeColor, nationality, location, ownerId);
    }
